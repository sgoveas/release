...
export OPENSHIFT_INSTALL_RELEASE_IMAGE_OVERRIDE="registry.build05.ci.openshift.org/ci-ln-4it8c42/release:latest"
export MULTI_RELEASE_IMAGE="registry.build05.ci.openshift.org/ci-ln-4it8c42/release:latest"
